...
bool importer::recordHasReferenceSemantics(
  ...
  if (!isa<clang::CXXRecordDecl>(decl) &&
      !importerImplPtr->SwiftContext.LangOpts.CForeignReferenceTypes)
    return false;
  ...
  auto semanticsKind = evaluateOrDefault(
      importerImplPtr->SwiftContext.evaluator,
      CxxRecordSemantics({decl, importerImplPtr->SwiftContext, importerImplPtr,
